...
14. `docs/14_payer_basis_and_payor_selection_rules.md`
15. `docs/15_normalization_rounding_and_derived_fields.md`
16. `docs/16_professional_fee_logic.md`
17. `docs/17_edge_cases_robotic_implants_emergency_mlc.md`
...
- payer-basis auto resolution across service, pharmacy, and PF
- LOS / ICU / ward normalization and OT / cath-lab derived-field handling
- advanced pharmacy controls
- service add-ons
- grouped residual adjustments
- robotic-charge and implant-selection behavior where used by finalized non-package families
- emergency / MLC edge-case behavior where surfaced by finalized logic
- professional-fee handling, including implementation-target vs review-only families
...
- payer-basis thresholds and fallback rules
- normalization, rounding, and derived driver behavior
- robotic / implant / emergency / MLC edge-case behavior
- PF behavior by family
