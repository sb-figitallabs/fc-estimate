...
- `scripts_reference/export_robotic_tkr_fc_estimate_builder.py`
  - Authoritative surgical non-daycare control and edge-case reference
  - Important for:
    - robotic detection and default thresholds
    - OT-consumables shortlist thresholds
    - service add-on prioritization
    - grouped residual thresholds
    - implant-sheet structure

- `scripts_reference/export_fc_professional_fee_analysis.py`
  - Authoritative PF behavior reference
  - Important for:
    - family-by-family PF treatment
    - modeled-vs-review-only PF distinction
    - PF payor-basis context
...
- `scripts_reference/test_surgical_workbook_logic.py`
  - Authoritative unit-test evidence for:
    - slot rounding
    - grouped residual promotion
    - OT-consumables piecewise thresholds
    - robotic detection and defaulting

- `scripts_reference/test_main_table_fc_actuals.py`
  - Authoritative unit-test evidence for:
    - OT / cath-lab derivation
    - LOS normalization
    - emergency / MLC logic
